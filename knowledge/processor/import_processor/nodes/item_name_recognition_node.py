...
from typing import Tuple, List, Any, Dict, final
...
if __name__ == '__main__':
    ...
    json_path = r"E:\atguigu\demo\workspace_pycharm\ShopKeeper-Brain\knowledge\processor\import_processor\output_dir\万用表RS-12的使用\万用表RS-12的使用\chunks.json"
