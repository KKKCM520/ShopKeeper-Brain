...
class DocumentSplitNode(BaseNode):
    ...
    def _validate_state(self, state:ImportGraphState) -> Tuple[str, str,int,int]:
        ...
        if (not max_content_length or max_content_length <= 0 or not min_content_length
    ...
    def _split_by_head(self, md_content:str, file_title:str) -> List[Dict[str,Any]]:
        ...
        def _flush():
            ...
            section = {
                "body":body,
                "title":title if title else file_title, #使用file_title为title进行兜底
...
#合并短section
    def _merge_short_section(self,current_sections: List[Dict[str,Any]], min_content_length:int) -> List[Dict[str,Any]]:
        ...
        for i in range(1,len(current_sections)):
            ...
            current_section_body = next_section.get("body")
            ...
            if is_short and same_parent:
                ...
                final_sections.append(next_section)
    ...
    def _backup_chunks(self,chunks:List[Dict[str,Any]],state: ImportGraphState):
        ...
        file_dir_obj = md_path_obj.parent
...
if __name__ == '__main__':
    ...
    md_path = r"E:\atguigu\demo\workspace_pycharm\ShopKeeper-Brain\knowledge\processor\import_processor\input_dir\test_spilt.md"
